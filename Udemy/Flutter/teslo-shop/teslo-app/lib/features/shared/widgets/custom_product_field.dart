...
class CustomProductField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final border = OutlineInputBorder(borderSide: const BorderSide(color: Colors.transparent), borderRadius: BorderRadius.circular(40));
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [if (isBottomField) BoxShadow(color: Colors.black.withOpacity(0.06), blurRadius: 5, offset: const Offset(0, 3))]),
      child: TextFormField(
        onChanged: onChanged,
