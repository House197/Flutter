      ...
      child: Column(
        children: [
          ...
          CustomTextFormField(
            ...
            onChanged: ref.read(loginFormNotifier.notifier).onEmailChange,
          ),
          ...
          Row(
            ...
            children: [const Text('¿No tienes cuenta?'), TextButton(onPressed: () => context.push('/register'), child: const Text('Crea una aquí'))],
          ),
          const Spacer(flex: 1),
        ],
      ),
